...
var itemPrefix = ['Awesome','Great','Good','Rusty','Shiny','Adamantium','Iron','Fairy','Dwarven','Elven','Old','Evil','Daemonic','Putrid', 'Rotten', 'Festering','Ballsy', 'Explodifying', 'Polished', 'Broken', 'Red', 'Black','Yellow', 'Green','Possessed', 'Super'];
...
var races = ['Human','Ork','Elf','Dwarf','Gnome','Dark elf','Troll','Panda','Pirate','Wolfen','Ogre','Donkey','Goblin','Hobgoblin','Troglodyte','Imp','Kobold','Vampire','Werewolf','Werebear'];
